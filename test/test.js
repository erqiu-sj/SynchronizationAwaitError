...
(function () {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, SynchronizationAwaitError(Promise.resolve({ res: "1" }), function (result) {
                        var replace = Object.assign(result, { res: parseInt(result.res) });
                        return replace;
                    }, { errorText: "hava a error!" })];
                case 1:
                    _a = _b.sent(), err = _a[0], val = _a[1];
